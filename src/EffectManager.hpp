...
typedef void(*UpdateFunc)(uint8_t dt, uint8_t speed, Led* leds, uint16_t numLeds);
...
public:
	...
	void execute(uint8_t effectId, uint8_t dt, uint8_t speed, Led* leds, uint16_t numLeds);
